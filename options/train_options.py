...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--save_epoch_freq', type=int, default=100, help='frequency of save point')
        ...
        parser.add_argument('--n_epochs', type=int, default=8000, help='number of epochs')
        parser.add_argument('--n_epochs_decay', type=int, default=2000, help='the number of epochs to linearly decay learning rate to zero')
